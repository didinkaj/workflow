        ...
        <div style="width: 80%; max-width: 900px; display: block; margin:0 auto;">
            <div>
                ...
                <div style="display: inline-block; width: 49%; text-align: right;">
                    <p style="font-size: 12px; width: 100%; text-align: right; color:#003366;"> A product of <strong><a style="color: #003366; text-decoration: none; font-weight: 800;" href="http://jdk.co.ke">JDK</a></strong></p>
                </div>
            </div>
        </div>
    </div>
